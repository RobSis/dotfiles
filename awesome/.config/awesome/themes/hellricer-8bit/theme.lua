...
local theme                                     = {}
theme.theme_dir                                 = require("awful.util").get_themes_dir() .. "hellricer-8bit"
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/hellricer-8bit"
theme.wallpaper                                 = theme.dir .. "/wall.png"
theme.font                                      = "unscii 12"
...
theme.titlebar_minimize_button_normal           = theme.theme_dir.."/titlebar/minimize_normal.png"
theme.titlebar_minimize_button_focus            = theme.theme_dir.."/titlebar/minimize_focus.png"
